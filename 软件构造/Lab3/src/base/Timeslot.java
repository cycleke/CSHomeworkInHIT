...
public class Timeslot {
   ...
   *
   * @param startTime
   *          the start time of the timeslot, not null
   * @param endTime
   *          the end time of the timeslot, not null
   */
   ...
   *
   * @param startText
   *          the text for the start time of the timeslot to parse such as "2020-03-01 14:00", not null
   * @param endText
   *          the text for the end time of the timeslot to parse such as "2020-03-01 14:00", not null
  ...
  public boolean intersect(Timeslot anotherTimeslot) {
    ...
    if (startTime.compareTo(anotherEndTime) >= 0)
      return false;
    if (endTime.compareTo(anotherStartTime) <= 0)
      return false;
    return true;
  }
