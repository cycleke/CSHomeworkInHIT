...
/**
 * This class {@link EntryState} is an immutable interface to respent the state of a {@link PlanningEntry}.
 *
 * @author cycleke
...
public interface EntryState {
   ...
   *           if the plan can't be allocated
   */
   ...
   *
   * @throws IllegalStateTransitionException
   *           if the plan is not ready to start
   */
   ...
   *
   * @throws IllegalStateTransitionException
   *           if the plan is unable to cancel
   */
   ...
   *
   * @throws IllegalStateTransitionException
   *           if the plan is not in state RUNNING before
   */
