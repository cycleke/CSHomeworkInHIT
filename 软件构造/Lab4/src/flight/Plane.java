...
public class Plane {
   ...
   *
   * @param id    the ID number of the plane, not null
   * @param type  the type of the plane, not null
   * @param seats the number of seats of the plane, must be positive
   * @param age   the age of the plane, non negative
   */
