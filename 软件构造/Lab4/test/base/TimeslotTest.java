...
public class TimeslotTest {
   ...
   *
   * Partition the inputs as follows: <q>startTime compare to endTime : < 0 <\q>
   */
   ...
   * <p> Testing strategy </p>
   *
   * Partition the inputs as follows: <q>startTime compare to endTime : < 0 , 0
   * <\q>
   */
   ...
   * <q>-1, -0, 0, +0, 1 mean left outside, left point, inside, right point, right
   * outside<\q>
   */
  @Test
  ...
  public void testEqualsAndHashCode() {
    ...
    assertNotEquals(timeslot1, null);
    assertNotEquals(timeslot1, "(2020-03-01 09:00, 2020-12-31 17:00");
    assertEquals(timeslot1, timeslot1);
    assertEquals(timeslot1, timeslot2);
    assertEquals(timeslot2, timeslot1);
    assertNotEquals(timeslot1, timeslot3);
    assertNotEquals(timeslot1, timeslot4);
